    ...
    return NextResponse.json({
      lesson: {
        ...
        storyLesson: lesson.storyLesson ? {
          id: lesson.storyLesson.id,
          title: lesson.storyLesson.title,
          narrative: lesson.storyLesson.narrative,
          character: lesson.storyLesson.character,
          setting: lesson.storyLesson.setting,
          mood: lesson.storyLesson.mood,
          choices: lesson.storyLesson.choices ? JSON.parse(lesson.storyLesson.choices) : null,
          languageCode: lesson.storyLesson.languageCode,
          readingLevel: lesson.storyLesson.readingLevel,
          estimatedReadingTime: lesson.storyLesson.estimatedReadingTime,
          ttsVoice: lesson.storyLesson.ttsVoice,
          ttsSpeed: lesson.storyLesson.ttsSpeed,
          ttsLanguage: lesson.storyLesson.ttsLanguage,
          chapters: lesson.storyLesson.chapters ? JSON.parse(lesson.storyLesson.chapters) : null,
          hasBranching: lesson.storyLesson.hasBranching,
          branchingPaths: lesson.storyLesson.branchingPaths ? JSON.parse(lesson.storyLesson.branchingPaths) : null,
          totalQuestions: lesson.storyLesson.totalQuestions,
          passingScore: lesson.storyLesson.passingScore,
          xpReward: lesson.storyLesson.xpReward,
          gemReward: lesson.storyLesson.gemReward,
        } : null,
